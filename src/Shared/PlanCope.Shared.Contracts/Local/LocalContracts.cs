...
public sealed record CreateSessionRequest(string ExamVersionId, string SchoolCode, string? ClassroomCode, string? CommissionCode, string StartedBy, JsonElement? Config);
