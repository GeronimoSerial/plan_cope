...
Implement batch **B3**, specified in `PROJECT-CLOSURE-PLAN.md` (search `B3 ·`). Read it in
...
Keep `_briefs/B3-PROGRESS.md` current. After **each wave**: the slices, the exact commands, what
